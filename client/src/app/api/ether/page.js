...
import { 
  Zap, AlertTriangle, RefreshCw, Layers, Radio, Cpu, Activity, Save, Square, FileEdit, X, Terminal, Shield, Server, Power 
} from 'lucide-react';
...
export default function EtherScan() {
  ...
  const initiateDeepScan = (ip, e) => {
    ...
    // Don't scan non-IP elements like the Implicit Switch ghost node
